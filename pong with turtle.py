...
def Winnerscreen_1():
    ...
    pen.hideturtle()
    pen.goto(0, 0)
    pen.write("{} Won!!".format(player_1), align="center", font=("Courier", 65, "normal"))
...
def Winnerscreen_2():
    ...
    pen.hideturtle()
    pen.goto(0, 0)
    pen.write("{} Won!!".format(player_2), align="center", font=("Courier", 65, "normal"))
...
while True:
    ...
    if ball.xcor() < -390:
        ...
        ball.dx *= -1
        pen.clear()
        pen.write("{} = {} {} = {}".format(player_1, Point_A, player_2, Point_B), align="center",
